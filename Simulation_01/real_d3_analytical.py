...
def u_analytical(z1, z2, z3, t):
    """
    Analytical solution: u(z1, z2, z3, t) = 4 * arctan(exp((4*omega/3) * (z1 + z2 + z3 + t/2)))
    ...
    return 4 * torch.arctan(torch.exp((4*omega/3.0) * (z1 + z2 + z3 + t/2.0)))
...
if __name__ == "__main__":
    ...
    with open("real_d3_results/analytic.csv", mode='w', newline='') as file:
    ...
    print("\nResults saved to real_d3_results/analytic.csv")
